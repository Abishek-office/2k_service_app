...
export default function BeforePaymentOrder() {
        ...
        <View //this is for black color opacity
          ...
          <View //this is for white color opacity
            ...
            <View style={{flex: 0.6}}>
              ...
              >
                <View style={styles.box_items}>
                  <Text style={styles.box_font}> Already Paid Amount:</Text>
                  <Text style={styles.box_font}>2700</Text>
                </View>
                <View style={styles.box_items}>
                  <Text style={styles.box_font}>Balance Amount:</Text>
                  <Text style={styles.box_font}>700</Text>
                </View>
